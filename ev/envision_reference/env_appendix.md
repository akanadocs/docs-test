...
* [Main Chart Category](#main-chart-category)
* [Common Characteristics](#common-characteristics)
	1. [New Chart](#new-chart)
	2. [Dataset Details](#dataset-details)
	3. [X-AXIS](#xaxis)
	4. [Series](#series)
* [Charts and Examples](#charts-and-examples)
* [Line Chart](#line-chart)
	1. [Example - Monthly Response Time](#line-chart-monthly-response-time)
* [Area Chart](#area-chart)
	1. [Example - Data Exchange per Container](#area-chart-data-exchange-per-container)
	2. [Example - Regional Throughput since Start](#area-chart-regional-throughput-since-start)
* [Pie Chart](#pie-chart)
	1. [Example - Traffic by Browser Agent](#pie-chart-traffic-by-browser-agent)
	2. [Example - Error Summary - Semi Donut](#pie-chart-error-summary-semi-donut)
	3. [Example - Sales Process (Funnnel/Pyramid)](#pie-chart-sales-process-funnel-pyramid)
* [Column Chart](#column-chart)
	1. [Example - Monthly Throughput per Service](#pie-chart-monthly-throughput-per-service)
* [Bar Chart](#bar-chart)
	1. [Example - API Traffic by App](#bar-chart-api-traffic-by-app)
	2. [Example - Success vs. Error (Stacked Bar Chart)](#bar-chart-success-vs-error)
* [Indicator Chart](#indicator-chart)
	1. [Example - Response Time Range](#indicator-chart-response-time-range)
