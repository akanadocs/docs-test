...
3. [Chart Types and Examples](#chart-types-examples)
	- [Data Mapping for Charts](#data-mapping-for-charts)
...
##### <a id="line-chart-monthly-response-time">Example: Line Chart - Monthly Response Time
...
##### <a id="area-chart-data-exchange-per-container>Example: Area Chart - Data Exchange per Container
...
<br>
##### <a id="area-chart-regional-throughput-since-start>Example: Area Chart - Regional Throughput Since Start
...
<br>
##### <a id="pie-chart-error-summary-semi-donut">Example: Pie Chart - Error Summary - Semi Donut
...
<br>
##### <a id="pie-chart-sales-process-funnel-pyramid">Example: Pie Chart - Sales Process (Funnel/Pyramid)
...
##### <a id="pie-chart-monthly-throughput-per-service">Example: Column Chart - Monthly Throughput per Service
...
##### <a id="bar-chart-api-traffic-by-app">Example: Bar Chart - API Traffic by App
