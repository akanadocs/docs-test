...
2. From the **Binding Type** drop-down, select the protocol that will be applied to the Binding Type you will be defining on subsequent binding configuration screens and click **Next** to continue. 
